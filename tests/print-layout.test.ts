...
const css = readFileSync(new URL("../src/print-document-fixes.css", import.meta.url), "utf8");
const printSource = readFileSync(new URL("../src/print-export.ts", import.meta.url), "utf8");
